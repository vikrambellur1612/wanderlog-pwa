...
const CACHE_NAME = 'wanderlog-v1.2.0';
const STATIC_CACHE = 'wanderlog-static-v1.2.0';
const DYNAMIC_CACHE = 'wanderlog-dynamic-v1.2.0';
...
console.log('WanderLog Service Worker v1.2.0 loaded');
