...
const CACHE_NAME = 'wanderlog-v1.0.0';
const STATIC_CACHE = 'wanderlog-static-v1.0.0';
const DYNAMIC_CACHE = 'wanderlog-dynamic-v1.0.0';
...
console.log('WanderLog Service Worker v1.0.0 loaded');
