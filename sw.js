...
const CACHE_NAME = 'wanderlog-v1.11.0';
const STATIC_CACHE = 'wanderlog-static-v1.11.0';
const DYNAMIC_CACHE = 'wanderlog-dynamic-v1.11.0';
...
self.addEventListener('message', (event) => {
  ...
  if (event.data && event.data.type === 'GET_VERSION') {
    event.ports[0].postMessage({ version: '1.11.0' });
  }
});
...
console.log('WanderLog Service Worker v1.11.0 loaded');
